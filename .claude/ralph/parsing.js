// Pure text parsing: the agent's own output (verdict sentinels, Acceptance
// Criteria self-report) and git's porcelain output. No side effects, no
// child processes, no filesystem — everything here is a plain function of
// its input, which is what makes it the cheapest part of the loop to reason
// about and the easiest to test in isolation.
//
...
// NOT check off anything automatically (see the caller in core.js's
// runIssue() for why this is fine for batch autonomy — resolveBaseRef()
// never waits on this).
