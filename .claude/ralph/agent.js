// The single place `claude -p` is spawned. Everything about HOW the agent is
// invoked lives here (model/effort pinning, stream-json event handling, the
// stdin-not-argv prompt hand-off); WHAT it is told lives in prompts.js, and
// what its answer means lives in parsing.js.
//
...
// parseVerdict() in parsing.js, which never has to know the format changed.
...
module.exports = { describeToolUse, runAgent };
